...
async def monday2(callback_query: types.CallbackQuery):
    ...
    retk.add(*b)
    back = surrogates.decode("	\u2728")
    await bot.answer_callback_query(callback_query.id, text=f"{back} Monday - second week {back}", show_alert=False)
...
async def tuesday2(callback_query: types.CallbackQuery):
    ...
    b = [f"{back}"]
    retk.add(*b)
    await bot.answer_callback_query(callback_query.id, text=f"{back} Tuesday - second week {back}", show_alert=False)
...
async def wednesday2(callback_query: types.CallbackQuery):
    ...
    b = [f"{back}"]
    retk.add(*b)
    await bot.answer_callback_query(callback_query.id, text=f"{back} Wednesday - second week {back}", show_alert=False)
...
async def thursday2(callback_query: types.CallbackQuery):
    ...
    b = [f"{back}"]
    retk.add(*b)
    await bot.answer_callback_query(callback_query.id, text=f"{back} Thursday - second week {back}", show_alert=False)
...
async def friday2(callback_query: types.CallbackQuery):
    ...
    b = [f"{back}"]
    retk.add(*b)
    await bot.answer_callback_query(callback_query.id, text=f"{back} Friday - second week {back}", show_alert=False)
